        ...
        <div class="card-body">
            ...
            <table class="data-table table table-striped" id="table2">
                ...
                <tbody>
                    ...
                    @if($post->category->nama_category == "Profile Desa" || $post->category->nama_category == "Sejarah Desa" || $post->category->nama_category == "Struktur Desa" || $post->category->nama_category == "Visi dan Misi")
                    <tr>
                        <td>{{ $post->title }}</td>
