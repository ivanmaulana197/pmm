          ...
          <div class="col">
            <div class="d-flex">
              <div class="calendar me-2"><span
                  class="calendar-month">{{$post->created_at->isoFormat('MMM')}}</span><span class="calendar-day">{{
                  $post->created_at->isoFormat('D') }}</span>
              </div>
              <div class="flex-1 fs--1">
                <h5 class="fs-0"><a href="#" class="text-decoration-none text-dark">{{ $post->title }}</a></h5>
                <p class="mb-0">by <a href="#!" class="text-decoration-none">{{ $post->user->name }}</a> &bull; {{
