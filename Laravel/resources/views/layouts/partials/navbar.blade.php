<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse ms-5 scrollbar" id="navbarStandard">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="#" role="button" aria-haspopup="true" aria-expanded="false" id="Home">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" role="button" aria-haspopup="true" aria-expanded="false" id="Berita">Berita</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" role="button" aria-haspopup="true" aria-expanded="false" id="About">About</a>
            </li>            
        </ul>
    </div>
