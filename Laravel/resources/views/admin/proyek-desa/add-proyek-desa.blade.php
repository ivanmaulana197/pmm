...
<div class="row g-3">
        ...
        <div class="card-body">
            <nav style="--falcon-breadcrumb-divider: '»';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Proyek Desa</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('proyek-desa.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('namaKegiatan') is-invalid @enderror" type="text"
                            name="namaKegiatan" placeholder="Masukkan Nama Kegiatan" value="{{ old('namaKegiatan')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('lokasi') is-invalid @enderror" type="text" name="lokasi"
                            placeholder="Masukkan Lokasi Proyek" value="{{ old('lokasi')}}">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control  @error('anggaran') is-invalid @enderror" type="number"
                                name="anggaran" placeholder="Masukkan Anggaran" value="{{ old('anggaran')}}">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group mb-2">
                            <input class="form-control  @error('volume') is-invalid @enderror" type="number"
                                name="volume" placeholder="Masukkan Volume Proyek" value="{{ old('volume')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('sumberDana') is-invalid @enderror" type="text"
                            name="sumberDana" placeholder="Masukkan Sumber Dana Proyek" value="{{ old('sumberDana')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('tahun') is-invalid @enderror" type="number" name="tahun"
                            placeholder="Masukkan Tahun Proyek" value="{{ old('tahun')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('pelaksana') is-invalid @enderror" type="text"
                            name="pelaksana" placeholder="Masukkan Pelaksana Proyek" value="{{ old('pelaksana')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control  @error('manfaat') is-invalid @enderror" type="text" name="manfaat"
                            placeholder="Masukkan Manfaat Proyek" value="{{ old('manfaat')}}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                            ...
                            <textarea id="keterangan" class="form-control @error('manfaat') is-invalid @enderror"
                                value="{{ old('manfaat')}}" placeholder="Masukkan Keterangan Proyek"
